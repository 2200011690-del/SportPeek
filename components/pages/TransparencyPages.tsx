...
export function LegalPage({ type }: { type: string }) {
  ...
  return <div className="legal-page"><span className="eyebrow">NEWSPEEK · MINH BẠCH</span><h1>{titles[type] ?? "Thông tin"}</h1><p className="legal-lead">Cập nhật lần cuối: 18/07/2026. Phương pháp này áp dụng cho bảng tin tổng hợp Việt Nam và quốc tế.</p><section><h2>Mạng lưới nguồn</h2><p>NewsPeek đọc RSS công khai từ các nhà xuất bản Việt Nam và quốc tế như VnExpress, Tuổi Trẻ, Thanh Niên, Dân trí, VietNamNet, BBC, The Guardian, Al Jazeera, NPR và DW. Nguồn có thể tạm dừng nếu feed lỗi hoặc chính sách của nhà xuất bản thay đổi.</p></section><section><h2>Dịch và tóm tắt</h2><p>AI gộp các dữ kiện chung, loại bỏ câu lặp, dịch bài quốc tế sang tiếng Việt và giữ riêng những điểm chưa thống nhất. Bản tóm tắt chỉ được tạo khi người đọc yêu cầu hoặc khi newsroom đã xử lý trước; hệ thống không tự bổ sung dữ kiện ngoài nguồn.</p></section><section><h2>Điểm nổi bật</h2><p>Điểm nổi bật được ước tính từ độ mới, số nguồn độc lập, uy tín nguồn và mức ảnh hưởng của sự kiện. Đây không phải lượt đọc, lượt chia sẻ hoặc số người xem thật của các tòa soạn.</p></section><section><h2>Quyền của nguồn tin</h2><p>NewsPeek chỉ hiển thị toàn văn khi nhà xuất bản chủ động cấp nội dung đó qua RSS. Nếu nguồn chỉ cấp metadata, chặn truy cập hoặc có paywall, NewsPeek hiển thị trích đoạn và liên kết bài gốc; hệ thống không vượt chặn và không tải lại video.</p></section></div>;
}
