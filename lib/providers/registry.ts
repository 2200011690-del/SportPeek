...
export type ProviderKind = "news" | "ai" | "notification";
...
export class ProviderRegistry {
  ...
  describe(): ProviderDescriptor[] {
    ...
    return [
      ...
      { kind: "notification", name: process.env.TELEGRAM_BOT_TOKEN && process.env.TELEGRAM_WEBHOOK_SECRET ? "telegram" : "disabled", state: process.env.TELEGRAM_BOT_TOKEN && process.env.TELEGRAM_WEBHOOK_SECRET ? "configured" : "configuration_required", capabilities: ["breaking_news", "daily_digest"] },
    ];
  }
}
