...
export const followSchema = z.object({ entityType: z.enum(["sport", "competition", "team", "player", "coach", "source", "journalist", "topic"]), entityId: z.string().uuid(), action: z.enum(["follow", "unfollow"]) });
